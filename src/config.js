// ---------------------------------------------------------------------------
// Tunable economy + war revamp defaults. Admins override via `config` table.
// ---------------------------------------------------------------------------
export const DEFAULTS = {
  ...
  war_cries: JSON.stringify([
    { id:'thunder',  name:'Thunder Drum', cost:5000,  effect:'tribe_buff',   magnitude:0.05, duration_h:6, stars:0 },
    { id:'blood',    name:'Blood Oath',   cost:15000, effect:'double_next',  magnitude:2.0, count:10,     stars:0 },
    { id:'ancestor', name:'Ancestor Call',cost:30000, effect:'instant_score',magnitude:500,               stars:0 },
  ]),
...
// Helper: get a parsed JSON config value
